...
const Header = () => {
    return ( 
        <header className="sticky top-0 w-full border-b-2 bg-drip-white border-drip-gray-light ">
              <nav className="flex flex-row justify-between py-6 custom-container">
                  <div className="flex flex-row items-center gap-4">
                      ...
                      <Link href="/docs">
                          ...
                          <a disabled className="pl-2 text-sm pointer-events-none md:text-lg text-drip-black/20">Web Designs</a>
                    
                  </div>

                  <div className="flex flex-row gap-4 items-center">
                    <Link href="/docs/how-to-use">
                         <a className="pl-3 text-sm border-r-2 md:text-lg border-drip-black/20 hover:text-drip-black/80">How to use</a>
                    </Link>
