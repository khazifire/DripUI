        ...
        category: [
            {
                ...
                listContainerStyle: "lg:flex lg:translate-x-0 lg:peer-checked:static absolute lg:static -translate-x-[150vh] lg:basis-3/5 justify-evenly font-extrabold peer-checked:translate-x-0 top-[88px] transition-transform duration-500 left-0 right-0  bg-black lg:bg-transparent",
                mobileListContainerStyle: "absolute -translate-x-[150vh] justify-evenly font-extrabold  peer-checked:translate-x-0 top-[88px] transition-all duration-700 left-0 right-0  bg-black",
